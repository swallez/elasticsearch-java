...
//    implementation("io.opentelemetry", "opentelemetry-api", openTelemetryVersion)
    ...
    testFixturesApi("jakarta.json.bind", "jakarta.json.bind-api", "2.0.0")
    ...
    testFixturesApi("org.eclipse", "yasson", "2.0.4") {
    ...
    testFixturesApi("org.testcontainers", "testcontainers", "1.17.3")
    testFixturesApi("org.testcontainers", "elasticsearch", "1.17.3")
